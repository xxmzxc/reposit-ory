...
%%==========================================================================================
%%
\begin{slide}{Store Sales Prediction}
\begin{center}
\twotonebox{\rotatebox{90}{Describe}}{\parbox{.86\textwidth}
{In this challenge, the title gives the daily sales volume of three products of two stores 
in three different countries from 2015 to 2018, 
and asks us to predict their sales volume in the next year.
\item
\smallskip
\textcolor{orange}{Seasons} and \textcolor{orange}{weekends} will affect sales.
\item
\smallskip
The country's \textcolor{orange}{GDP} will also have an impact on sales.
}}
...
{
{To sum up, we can find that there are three countries, 
two stores and three products, so there will be 18 combinations. 
The training data covers 2015-2018, and the test data requires us to predict 2019. 
There is no missing value in training data and test data.
Next, we will analyze the data by viewing the chart.
}
}}
...
%%==========================================================================================
\begin{slide}[toc=,bm=]{Daily sales of 2015-2018}
\twotonebox {\rotatebox{90}{Defn}}{\parbox{.88\textwidth}
{
{From the above chart, 
we can see that the sales volume of each product at the end of each year is much higher than the average, 
and the sales volume of \textcolor{orange}{Kaggle Hat and Kaggle Mug} 
seems to have seasonal characteristics, 
while the sales volume of Kaggle Sticker does not see obvious seasonal changes, 
so we should consider adding \textcolor{orange}{Fourier characteristics} for Kaggle Hat and Kaggle Mug.
}
}}
...
\begin{figure}     
\centering     
\includegraphics[totalheight=2.8in]{05.eps}     
\caption{Monthly sales of 2015-2018(1)}     
% \label{fig:test} 
\end{figure}
%%==========================================================================================
\begin{note}
...
\begin{figure}     
\centering     
\includegraphics[totalheight=2.8in]{06.eps}     
...
%%==========================================================================================
%%==========================================================================================%%==========================================================================================
\begin{slide}{Sales per day of the week}
\begin{figure}     
\centering     
\includegraphics[totalheight=3.0in]{07.eps}     
\caption{Sales per day of the week}     
% \label{fig:test} 
\end{figure}
%%==========================================================================================
\begin{note}
...
%%==========================================================================================
%%==========================================================================================
\begin{slide}[toc=,bm=]{Sales per day of the week}
\twotonebox {\rotatebox{90}{Defn}}{\parbox{.88\textwidth}
{
{From the Sales per day of the week, we can see that the sales volume on the weekend is higher than that on the weekday, which means that the week also has seasonal characteristics. For such a short period of time, we should consider adding \textcolor{orange}{seasonal indicators}.
}
}}
...
%%=============================================================================================
\begin{slide}[toc=,bm=]{Method analysis}
\twotonebox {\rotatebox{90}{Defn}}{\parbox{.88\textwidth}
{
...
\begin{figure}     
\centering     
\includegraphics[totalheight=2.8in]{11.eps}     
\caption{GDP of 2015-2018}     
\label{fig:test} 
\end{figure}
...
%%=============================================================================================
\begin{slide}[toc=,bm=]{Model Training}
\twotonebox {\rotatebox{90}{Defn}}{\parbox{.88\textwidth}
{
{The model uses the linear regression model in sk-learn and uses SMAPE as the loss function.The training results of the model are as follows.:
}
}}
\begin{figure}     
\centering     
\includegraphics[totalheight=2.8in]{12.eps}     
...
\begin{figure}     
\centering     
\includegraphics[totalheight=2.4in]{13.eps}     
\caption{Model Training}     
\label{fig:test} 
\end{figure}
\bigskip
